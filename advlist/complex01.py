...
def main():
    ...
    #extend list by list2 (combine both lists together into a single list)
    list1.extend(list2)
...
# sorry webex is really slowing down on me, I can't type in the chat bar
# but looks good now!
# can you tell the group that my webex is frozen?
#sure
